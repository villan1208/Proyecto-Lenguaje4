...
import { useNavigate } from "react-router-dom"; // ⬅️ Redirección a formulario de edición

const PreviewContactos = () => {
  const [socials, setSocials] = useState({});
  const [userId, setUserId] = useState(null);
  const navigate = useNavigate(); // ⬅️ Hook para navegar a "/contactos"
  ...
  return (
    <section className="vista-previa-section">
      ...
      {/* ✅ Historia de Usuario:
          Como usuario, quiero poder saltar a la sección de edición desde la vista previa con un clic,
          para corregir o actualizar información de inmediato. */}
      <button
        onClick={() => navigate("/contactos")} // Ruta al formulario de edición
